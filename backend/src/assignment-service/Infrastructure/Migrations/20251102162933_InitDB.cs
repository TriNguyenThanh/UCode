        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    result_file_ref = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    language_limit_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    problem_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    lang = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    time_factor = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    memory_kb_override = table.Column<int>(type: "int", nullable: true),
                    head = table.Column<string>(type: "NVARCHAR(MAX)", maxLength: 4000, nullable: true),
                    body = table.Column<string>(type: "NVARCHAR(MAX)", maxLength: 4000, nullable: true),
                    tail = table.Column<string>(type: "NVARCHAR(MAX)", maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_language_limit", x => x.language_limit_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    best_submission_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    assignment_user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    problem_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    submission_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_best_submission", x => x.best_submission_id);
                    table.ForeignKey(
                        name: "fk_best_submission_submission_submission_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_best_submission_assignment_user_id",
                table: "best_submission",
                column: "assignment_user_id");

            migrationBuilder.CreateIndex(
                name: "ix_best_submission_assignment_user_id_problem_id",
                table: "best_submission",
                columns: new[] { "assignment_user_id", "problem_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_best_submission_problem_id",
                table: "best_submission",
                column: "problem_id");

            migrationBuilder.CreateIndex(
                name: "ix_best_submission_submission_id",
                table: "best_submission",
