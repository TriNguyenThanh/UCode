...
public static class AssignmentDbContextSeed
{
    ...
    public static async Task SeedAsync(AssignmentDbContext context)
    {
        ...
        {
            // Student 1 - Problem 1 (Two Sum) - First attempt (Wrong Answer)
            new Submission
            {
                ...
                AssignmentId = assignment1.AssignmentId,
                ProblemId = problem1.ProblemId,
                DatasetId = datasets[1].DatasetId, // Basic Tests
            ...
            // Student 1 - Problem 1 (Two Sum) - Second attempt (Accepted)
            new Submission
            {
                SubmissionId = Guid.NewGuid(),
                UserId = student1Id,
            ...
            // Student 1 - Problem 2 (Reverse String) - First attempt (Accepted)
            new Submission
            {
                SubmissionId = Guid.NewGuid(),
                UserId = student1Id,
                ...
                DatasetId = datasets[4].DatasetId, // Basic Tests
            ...
            // Student 2 - Problem 1 (Two Sum) - Accepted
            new Submission
            {
                SubmissionId = Guid.NewGuid(),
                UserId = student2Id,
                ...
                ProblemId = problem1.ProblemId,
                DatasetId = datasets[1].DatasetId,
                SourceCodeRef = "submissions/student2/two-sum/attempt1.java",
                Language = "java",
                CompareResult = "AC",
                Status = "ACCEPTED",
                ErrorCode = null,
            ...
            // Student 2 - Problem 2 (Reverse String) - Accepted
            new Submission
            {
                SubmissionId = Guid.NewGuid(),
                UserId = student2Id,
                ...
                SourceCodeRef = "submissions/student2/reverse-string/attempt1.cpp",
                Language = "cpp",
                CompareResult = "AC",
                Status = "ACCEPTED",
                ErrorCode = null,
            ...
            // Student 1 - Problem 3 (Fibonacci) - Time Limit Exceeded
            new Submission
            {
                SubmissionId = Guid.NewGuid(),
                UserId = student1Id,
                AssignmentId = assignment2.AssignmentId,
                ProblemId = problem3.ProblemId,
                DatasetId = datasets[6].DatasetId, // Official Tests
                SourceCodeRef = "submissions/student1/fibonacci/attempt1.py",
                Language = "python",
                CompareResult = "TLE",
                Status = "TIME_LIMIT_EXCEEDED",
                ErrorCode = "TLE",
                ErrorMessage = "Time limit exceeded on test case 3",
                TotalTestcase = 4,
                PassedTestcase = 2,
                TotalTime = 2500,
                TotalMemory = 2048,
        ...
        Console.WriteLine("\nSeeding BestSubmissions...");
        var bestSubmissions = new List<BestSubmission>
        {
            // Student 1 - Problem 1 (best submission: attempt2)
            new BestSubmission
            {
                BestSubmissionId = Guid.NewGuid(),
                AssignmentUserId = assignmentUsers[0].AssignmentUserId,
                ProblemId = problem1.ProblemId,
                SubmissionId = submissions[1].SubmissionId, // The AC submission
                Score = 100,
                MaxScore = 100,
                TotalTime = 98,
                TotalMemory = 1920,
            ...
            {
                BestSubmissionId = Guid.NewGuid(),
                AssignmentUserId = assignmentUsers[1].AssignmentUserId,
                ProblemId = problem1.ProblemId,
                SubmissionId = submissions[3].SubmissionId,
                Score = 100,
                MaxScore = 100,
                TotalTime = 150,
                TotalMemory = 4096,
            ...
            new BestSubmission
            {
                ...
                AssignmentUserId = assignmentUsers[1].AssignmentUserId,
                ProblemId = problem2.ProblemId,
                SubmissionId = submissions[4].SubmissionId,
                Score = 100,
                MaxScore = 100,
                TotalTime = 85,
                TotalMemory = 1536,
